...
import { pickThemeOverrides as parseThemeOverrides } from "../src/themes/overrides";
...
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  const theme = resolveTheme(getString(req.query.theme) ?? "xai", parseThemeOverrides(req.query as Record<string, unknown>));
